    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Edit User: {{ $user->name }}</h1>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8">
                <form action="{{ route('admin.user.update', $user) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="password"
                            class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Password Baru (Biarkan
